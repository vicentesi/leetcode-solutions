...
class Solution1823 {
    public int findTheWinner(int n, int k) {
        ...
        while (list.size() > 1) {
            ...
            if (count == 0) {
                // System.out.println(list.toString() + " -> rem: " + list.get(pos));
    ...
    public static void main(String[] args) {
        Solution1823 sol = new Solution1823();

        System.out.println(sol.findTheWinner(5, 2));
        System.out.println(sol.findTheWinner(6, 5));
        System.out.println(sol.findTheWinner(1, 1));
    }
}
